      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="teacher_profile.php"><i class="fa fa-bar-chart fa-fw"></i>Timetable</a></li>
            
            <li><a href="teacher_logout.php"><i class="fa fa-eject fa-fw"></i>Sign Out</a></li>
          </ul>  
        </nav>
      </div>
      <!-- Main content -->
...
$sql="SELECT * FROM timetable where department_name = '{$_SESSION['department_name']}' AND lecName = '{$_SESSION['name']}'   ";
