...
mysqli_query($conn, "UPDATE timetable set ttid='" . $_POST["ttid"] . "', room= '" . $_POST["venue"] . "', 
			 ClassDay= '" . $_POST["ClassDay"] . "' , timeStart= '" . $_POST["timeStart"] . "',
...
?>			
			...
			<input type="hidden" name="ttid" value="<?php echo $rows['ttid']; ?>">
              <div class="row form-group">
				...
				<input type="text" class="form-control"  name="ClassDay" value="<?php echo $rows['ClassDay']; ?>"  placeholder="<?php echo $rows['ClassDay']; ?>">   
                </div>
				<div class="col-lg-3 col-md-3 form-group">                  
