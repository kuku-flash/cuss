        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
			...
			<div class="form-group">
              ...
              <a href="department_add_unit.php">  <button  class="templatemo-white-button">Add New</button> </a>
...
?>				
                <tbody>
                  <tr>
                    ...
                    <td><a href="delete_unit.php?id=<?php echo $rows['id']; ?>" class="templatemo-link">Delete</a></td>
                  </tr>
<?php 
}
?>              
