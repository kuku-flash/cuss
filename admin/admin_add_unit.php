      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="admin_add_unit_script.php" class="templatemo-login-form" method="post">
              <div class="row form-group">
				...
				?>	
                  <select class="form-control" name="deparment_name">
				<?php
              ...
              <div class="form-group text-right">
				...
				<a href="admin_unit_list.php" ><input type="button" class="templatemo-white-button" value="Back"></a>
