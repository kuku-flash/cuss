      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="admin_faculty_list.php" class="active"><i class="fa fa-bar-chart fa-fw"></i>Faculty</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            <h2 class="margin-bottom-10">Add New Faculty</h2>
			
            <form action="admin_add_faculty_script.php" class="templatemo-login-form" method="post">
              <div class="row form-group">

                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">Faculty Name</label>
              ...
              <div class="form-group text-right">
               ...
               <a href="admin_faculty_list.php" ><input type="button" class="templatemo-white-button" value="Back"></a>
              </div>                           
