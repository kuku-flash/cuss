      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="admin_add_lecturer_script.php" class="templatemo-login-form" method="post">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">Full Name</label>
                    <input type="text" class="form-control"  placeholder="Fullname" name="lecturer_name" required="">                  
                </div>
				...
				<div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputNewPassword">Specialization</label>
