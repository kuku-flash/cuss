      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <h2 class="margin-bottom-10">Department</h2>
			<div class="form-group">
                
              <a href="admin_add_department.php">  <button  class="templatemo-white-button">Add New</button> </a>
...
?>
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">Faculty_id <span class="caret"></span></a></td>
...
?>				
                <tbody>
                  <tr>
                    ...
                    <td><a href="delete_department.php?id=<?php echo $rows['id']; ?>" class="templatemo-link">Delete</a></td>
                  </tr>
<?php 
}
?>              
