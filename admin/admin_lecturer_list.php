      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <h2 class="margin-bottom-10">Lecturers</h2>
			<div class="form-group">
                
              <a href="admin_add_lecturer.php">  <button  class="templatemo-white-button">Add New</button> </a>
...
?>
                <thead>
                  <tr>
                    ...
                    <td><a href="" class="white-text templatemo-sort-by">specialization<span class="caret"></span></a></td>
					<td><a href="" class="white-text templatemo-sort-by">Department<span class="caret"></span></a></td>
					<td><a href="" class="white-text templatemo-sort-by">Access level<span class="caret"></span></a></td>
                    <td>Edit</td>
                    <td>Delete</td>
                  </tr>
                </thead>
...
?>				
                <tbody>
                  <tr>
                    ...
                    <td><a href="admin_edit_lecturer.php?id=<?php echo $rows['id']; ?>" class="templatemo-edit-btn">Edit</a></td>
                    <td><a href="delete_lecturer.php?id=<?php echo $rows['id']; ?>" class="templatemo-link">Delete</a></td>
                  </tr>
<?php 
}
?>              
