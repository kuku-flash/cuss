      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget no-padding">
            <h2 class="margin-bottom-10">Faculty</h2>
			<div class="form-group">
                
              <a href="admin_add_faculty.php">  <button  class="templatemo-white-button">Add New</button> </a>
...
?>				
                <tbody>
                  <tr>
                    ...
                    <td><a href="delete_faculty.php?id=<?php echo $rows['id']; ?>" class="templatemo-link">Delete</a></td>
                  </tr>
<?php 
}
?>              
