      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="department_unit_list.php" class="active"><i class="fa fa-bar-chart fa-fw"></i>Units</a></li>
			<li><a href="department_timetable_list.php"><i class="fa fa-bar-chart fa-fw"></i>Timetable</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form action="department_add_unit_script.php" class="templatemo-login-form" method="post">
              <div class="row form-group">
                <div class="col-lg-3 col-md-3 form-group">                  
                    <label for="inputFirstName">Unit Code</label>
                    <input type="text" class="form-control"  placeholder="" name="unit_code" required="">                  
                </div>
				<div class="col-lg-8 col-md-8 form-group">                  
                    <label for="inputFirstName">Unit Name</label>
                    <input type="text" class="form-control"  placeholder="" name="unit_name" required="">                  
                </div>
				
                <div class="col-lg-6 col-md-6 form-group"> 
				
                  <label class="control-label templatemo-block">Department Name</label>   
				<?php
					include 'config.php';
              ...
              <div class="form-group text-right">
				...
				<a href="department_unit_list.php" ><input type="button" class="templatemo-white-button" value="Back"></a>
